			...
			<div id="kt_app_header" class="app-header">
				...
				<div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
					...
					<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0 me-5 me-lg-0">
						<a href="../../demo46/dist/index.html">
							<img alt="Logo" src="assets/media/logos/demo46.svg" class="d-none d-sm-block" />
							<img alt="Logo" src="assets/media/logos/demo46-small.svg" class="d-block d-sm-none" />
						</a>
					</div>
					<!--end::Logo-->
					...
					<div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1"
							...
							<div class="menu menu-rounded menu-active-bg menu-state-primary menu-column menu-lg-row menu-title-gray-700 menu-icon-gray-500 menu-arrow-gray-500 menu-bullet-gray-500 my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0"
										...
										<div class="menu-state-bg menu-extended overflow-hidden overflow-lg-visible"
											...
											<div class="row">
												...
												<div class="col-lg-8 mb-3 mb-lg-0 py-3 px-3 py-lg-6 px-lg-6">
													...
													<div class="row">
														...
														<div class="col-lg-6 mb-3">
															...
															<div class="menu-item p-0 m-0">
																<!--begin:Menu link-->
																<a href="../../demo46/dist/dashboards/ecommerce.html"
																	class="menu-link">
																	<span
																		class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
																		<i
														...
														<div class="col-lg-6 mb-3">
															...
															<div class="menu-item p-0 m-0">
																<!--begin:Menu link-->
																<a href="../../demo46/dist/dashboards/projects.html"
																	class="menu-link">
																	<span
																		class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
																		<i
														...
														<div class="col-lg-6 mb-3">
															...
															<div class="menu-item p-0 m-0">
																<!--begin:Menu link-->
																<a href="../../demo46/dist/dashboards/online-courses.html"
																	class="menu-link">
																	<span
																		class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
																		<i
														...
														<div class="col-lg-6 mb-3">
															...
															<div class="menu-item p-0 m-0">
																<!--begin:Menu link-->
																<a href="../../demo46/dist/dashboards/marketing.html"
																	class="menu-link">
																	<span
																		class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
																		<i
														...
														<div class="col-lg-6 mb-3">
															...
															<div class="menu-item p-0 m-0">
																<!--begin:Menu link-->
																<a href="../../demo46/dist/dashboards/bidding.html"
																	class="menu-link">
																	<span
																		class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
																		<i
														...
														<div class="col-lg-6 mb-3">
															...
															<div class="menu-item p-0 m-0">
																<!--begin:Menu link-->
																<a href="../../demo46/dist/dashboards/pos.html"
																	class="menu-link">
																	<span
																		class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
																		<i
														...
														<div class="col-lg-6 mb-3">
															...
															<div class="menu-item p-0 m-0">
																<!--begin:Menu link-->
																<a href="../../demo46/dist/dashboards/call-center.html"
																	class="menu-link">
																	<span
																		class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
													...
													<div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-2 mx-5">
														...
														<a href="../../demo46/dist/landing.html"
												...
												<div
													...
													<div class="menu-item p-0 m-0">
														<!--begin:Menu link-->
														<a href="../../demo46/dist/dashboards/logistics.html"
													...
													<div class="menu-item p-0 m-0">
														<!--begin:Menu link-->
														<a href="../../demo46/dist/dashboards/website-analytics.html"
															class="menu-link py-2">
													...
													<div class="menu-item p-0 m-0">
														<!--begin:Menu link-->
														<a href="../../demo46/dist/dashboards/finance-performance.html"
															class="menu-link py-2">
													...
													<div class="menu-item p-0 m-0">
														<!--begin:Menu link-->
														<a href="../../demo46/dist/dashboards/store-analytics.html"
															class="menu-link py-2">
													...
													<div class="menu-item p-0 m-0">
														<!--begin:Menu link-->
														<a href="../../demo46/dist/dashboards/social.html"
															class="menu-link py-2">
													...
													<div class="menu-item p-0 m-0">
														<!--begin:Menu link-->
														<a href="../../demo46/dist/dashboards/delivery.html"
															class="menu-link py-2">
													...
													<div class="menu-item p-0 m-0">
														<!--begin:Menu link-->
														<a href="../../demo46/dist/dashboards/crypto.html"
															class="menu-link py-2">
													...
													<div class="menu-item p-0 m-0">
														<!--begin:Menu link-->
														<a href="../../demo46/dist/dashboards/school.html"
															class="menu-link py-2">
													...
													<div class="menu-item p-0 m-0">
														<!--begin:Menu link-->
														<a href="../../demo46/dist/dashboards/podcast.html"
															class="menu-link py-2">
														...
														<div class="col-lg-8">
															...
															<div class="row">
																...
																<div class="col-lg-3 mb-6 mb-lg-0">
																	...
																	<div class="menu-item p-0 m-0">
																		<!--begin:Menu link-->
																		<a href="../../demo46/dist/pages/user-profile/overview.html"
																			class="menu-link">
																	...
																	<div class="menu-item p-0 m-0">
																		<!--begin:Menu link-->
																		<a href="../../demo46/dist/pages/user-profile/projects.html"
																			class="menu-link">
																	...
																	<div class="menu-item p-0 m-0">
																		<!--begin:Menu link-->
																		<a href="../../demo46/dist/pages/user-profile/campaigns.html"
																			class="menu-link">
																	...
																	<div class="menu-item p-0 m-0">
																		<!--begin:Menu link-->
																		<a href="../../demo46/dist/pages/user-profile/documents.html"
																			class="menu-link">
																	...
																	<div class="menu-item p-0 m-0">
																		<!--begin:Menu link-->
																		<a href="../../demo46/dist/pages/user-profile/followers.html"
																			class="menu-link">
																...
																<div class="col-lg-3 mb-6 mb-lg-0">
																	...
																	<div class="mb-6">
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/pages/about.html"
																				class="menu-link">
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/pages/team.html"
																				class="menu-link">
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/pages/contact.html"
																				class="menu-link">
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/pages/licenses.html"
																				class="menu-link">
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/pages/sitemap.html"
																				class="menu-link">
																	...
																	<div class="mb-0">
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/pages/careers/list.html"
																				class="menu-link">
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/pages/careers/apply.html"
																				class="menu-link">
																				<span class="menu-title">Careers
																					Apply</span>
																			</a>
																...
																<div class="col-lg-3 mb-6 mb-lg-0">
																	...
																	<div class="mb-6">
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/pages/faq/classic.html"
																				class="menu-link">
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/pages/faq/extended.html"
																				class="menu-link">
																				<span class="menu-title">FAQ
																					Extended</span>
																			</a>
																	...
																	<div class="mb-6">
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/pages/blog/home.html"
																				class="menu-link">
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/pages/blog/post.html"
																				class="menu-link">
																				<span class="menu-title">Blog
																					Post</span>
																			</a>
																	...
																	<div class="mb-0">
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/pages/pricing/column.html"
																				class="menu-link">
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/pages/pricing/table.html"
																				class="menu-link">
																...
																<div class="col-lg-3 mb-6 mb-lg-0">
																	...
																	<div class="mb-0">
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/pages/social/feeds.html"
																				class="menu-link">
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/pages/social/activity.html"
																				class="menu-link">
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/pages/social/followers.html"
																				class="menu-link">
																				<span
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/pages/social/settings.html"
																				class="menu-link">
														...
														<div class="col-lg-5 mb-6 mb-lg-0">
															...
															<div class="row">
																...
																<div class="col-lg-6">
																	...
																	<div class="menu-item p-0 m-0">
																		<!--begin:Menu link-->
																		<a href="../../demo46/dist/account/overview.html"
																			class="menu-link">
																			<span class="menu-title">Overview</span>
																		</a>
																		<!--end:Menu link-->
																	...
																	<div class="menu-item p-0 m-0">
																		<!--begin:Menu link-->
																		<a href="../../demo46/dist/account/settings.html"
																			class="menu-link">
																			<span class="menu-title">Settings</span>
																		</a>
																		<!--end:Menu link-->
																	...
																	<div class="menu-item p-0 m-0">
																		<!--begin:Menu link-->
																		<a href="../../demo46/dist/account/security.html"
																			class="menu-link">
																	...
																	<div class="menu-item p-0 m-0">
																		<!--begin:Menu link-->
																		<a href="../../demo46/dist/account/activity.html"
																			class="menu-link">
																			<span class="menu-title">Activity</span>
																		</a>
																		<!--end:Menu link-->
																	...
																	<div class="menu-item p-0 m-0">
																		<!--begin:Menu link-->
																		<a href="../../demo46/dist/account/billing.html"
																			class="menu-link">
																...
																<div class="col-lg-6">
																	...
																	<div class="menu-item p-0 m-0">
																		<!--begin:Menu link-->
																		<a href="../../demo46/dist/account/statements.html"
																			class="menu-link">
																	...
																	<div class="menu-item p-0 m-0">
																		<!--begin:Menu link-->
																		<a href="../../demo46/dist/account/referrals.html"
																			class="menu-link">
																	...
																	<div class="menu-item p-0 m-0">
																		<!--begin:Menu link-->
																		<a href="../../demo46/dist/account/api-keys.html"
																			class="menu-link">
																	...
																	<div class="menu-item p-0 m-0">
																		<!--begin:Menu link-->
																		<a href="../../demo46/dist/account/logs.html"
																			class="menu-link">
													...
													<div class="row">
														...
														<div class="col-lg-3 mb-6 mb-lg-0">
															...
															<div class="mb-6">
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="../../demo46/dist/authentication/layouts/corporate/sign-in.html"
																		class="menu-link">
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="../../demo46/dist/authentication/layouts/corporate/sign-up.html"
																		class="menu-link">
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="../../demo46/dist/authentication/layouts/corporate/two-factor.html"
																		class="menu-link">
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="../../demo46/dist/authentication/layouts/corporate/reset-password.html"
																		class="menu-link">
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="../../demo46/dist/authentication/layouts/corporate/new-password.html"
																		class="menu-link">
															...
															<div class="mb-0">
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="../../demo46/dist/authentication/layouts/overlay/sign-in.html"
																		class="menu-link">
																		<span class="menu-title">Sign-In</span>
																	</a>
																	<!--end:Menu link-->
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="../../demo46/dist/authentication/layouts/overlay/sign-up.html"
																		class="menu-link">
																		<span class="menu-title">Sign-Up</span>
																	</a>
																	<!--end:Menu link-->
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="../../demo46/dist/authentication/layouts/overlay/two-factor.html"
																		class="menu-link">
																		<span class="menu-title">Two-Factor</span>
																	</a>
																	<!--end:Menu link-->
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="../../demo46/dist/authentication/layouts/overlay/reset-password.html"
																		class="menu-link">
																		<span class="menu-title">Reset Password</span>
																	</a>
																	<!--end:Menu link-->
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="../../demo46/dist/authentication/layouts/overlay/new-password.html"
																		class="menu-link">
																		<span class="menu-title">New Password</span>
																	</a>
																	<!--end:Menu link-->
														...
														<div class="col-lg-3 mb-6 mb-lg-0">
															...
															<div class="mb-6">
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="../../demo46/dist/authentication/layouts/creative/sign-in.html"
																		class="menu-link">
																		<span class="menu-title">Sign-in</span>
																	</a>
																	<!--end:Menu link-->
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="../../demo46/dist/authentication/layouts/creative/sign-up.html"
																		class="menu-link">
																		<span class="menu-title">Sign-up</span>
																	</a>
																	<!--end:Menu link-->
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="../../demo46/dist/authentication/layouts/creative/two-factor.html"
																		class="menu-link">
																		<span class="menu-title">Two-Factor</span>
																	</a>
																	<!--end:Menu link-->
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="../../demo46/dist/authentication/layouts/creative/reset-password.html"
																		class="menu-link">
																		<span class="menu-title">Reset Password</span>
																	</a>
																	<!--end:Menu link-->
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="../../demo46/dist/authentication/layouts/creative/new-password.html"
																		class="menu-link">
																		<span class="menu-title">New Password</span>
																	</a>
																	<!--end:Menu link-->
															...
															<div class="mb-6">
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="../../demo46/dist/authentication/layouts/fancy/sign-in.html"
																		class="menu-link">
																		<span class="menu-title">Sign-In</span>
																	</a>
																	<!--end:Menu link-->
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="../../demo46/dist/authentication/layouts/fancy/sign-up.html"
																		class="menu-link">
																		<span class="menu-title">Sign-Up</span>
																	</a>
																	<!--end:Menu link-->
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="../../demo46/dist/authentication/layouts/fancy/two-factor.html"
																		class="menu-link">
																		<span class="menu-title">Two-Factor</span>
																	</a>
																	<!--end:Menu link-->
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="../../demo46/dist/authentication/layouts/fancy/reset-password.html"
																		class="menu-link">
																		<span class="menu-title">Reset Password</span>
																	</a>
																	<!--end:Menu link-->
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="../../demo46/dist/authentication/layouts/fancy/new-password.html"
																		class="menu-link">
																		<span class="menu-title">New Password</span>
																	</a>
																	<!--end:Menu link-->
														...
														<div class="col-lg-3 mb-6 mb-lg-0">
															...
															<div class="mb-0">
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="../../demo46/dist/authentication/extended/multi-steps-sign-up.html"
																		class="menu-link">
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="../../demo46/dist/authentication/general/welcome.html"
																		class="menu-link">
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="../../demo46/dist/authentication/general/verify-email.html"
																		class="menu-link">
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="../../demo46/dist/authentication/general/coming-soon.html"
																		class="menu-link">
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="../../demo46/dist/authentication/general/password-confirmation.html"
																		class="menu-link">
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="../../demo46/dist/authentication/general/account-deactivated.html"
																		class="menu-link">
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="../../demo46/dist/authentication/general/error-404.html"
																		class="menu-link">
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="../../demo46/dist/authentication/general/error-500.html"
																		class="menu-link">
														...
														<div class="col-lg-3 mb-6 mb-lg-0">
															...
															<div class="mb-0">
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="../../demo46/dist/authentication/email/welcome-message.html"
																		class="menu-link">
																		<span class="menu-title">Welcome Message</span>
																	</a>
																	<!--end:Menu link-->
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="../../demo46/dist/authentication/email/reset-password.html"
																		class="menu-link">
																		<span class="menu-title">Reset Password</span>
																	</a>
																	<!--end:Menu link-->
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="../../demo46/dist/authentication/email/subscription-confirmed.html"
																		class="menu-link">
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="../../demo46/dist/authentication/email/card-declined.html"
																		class="menu-link">
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="../../demo46/dist/authentication/email/promo-1.html"
																		class="menu-link">
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="../../demo46/dist/authentication/email/promo-2.html"
																		class="menu-link">
																...
																<div class="menu-item p-0 m-0">
																	<!--begin:Menu link-->
																	<a href="../../demo46/dist/authentication/email/promo-3.html"
																		class="menu-link">
															...
															<div class="row">
																...
																<div class="col-lg-4 mb-6 mb-lg-0">
																	...
																	<div class="mb-0">
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/utilities/modals/general/invite-friends.html"
																				class="menu-link">
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/utilities/modals/general/view-users.html"
																				class="menu-link">
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/utilities/modals/general/select-users.html"
																				class="menu-link">
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/utilities/modals/general/upgrade-plan.html"
																				class="menu-link">
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/utilities/modals/general/share-earn.html"
																				class="menu-link">
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/utilities/modals/forms/new-target.html"
																				class="menu-link">
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/utilities/modals/forms/new-card.html"
																				class="menu-link">
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/utilities/modals/forms/new-address.html"
																				class="menu-link">
																				<span class="menu-title">New
																					Address</span>
																			</a>
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/utilities/modals/forms/create-api-key.html"
																				class="menu-link">
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/utilities/modals/forms/bidding.html"
																				class="menu-link">
																...
																<div class="col-lg-4 mb-6 mb-lg-0">
																	...
																	<div class="mb-6">
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/utilities/modals/wizards/create-app.html"
																				class="menu-link">
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/utilities/modals/wizards/create-campaign.html"
																				class="menu-link">
																				<span class="menu-title">Create
																					Campaign</span>
																			</a>
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/utilities/modals/wizards/create-account.html"
																				class="menu-link">
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/utilities/modals/wizards/create-project.html"
																				class="menu-link">
																				<span class="menu-title">Create
																					Project</span>
																			</a>
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/utilities/modals/wizards/top-up-wallet.html"
																				class="menu-link">
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/utilities/modals/wizards/offer-a-deal.html"
																				class="menu-link">
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/utilities/modals/wizards/two-factor-authentication.html"
																				class="menu-link">
																	...
																	<div class="mb-0">
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/utilities/search/horizontal.html"
																				class="menu-link">
																				<span
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/utilities/search/vertical.html"
																				class="menu-link">
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/utilities/modals/search/users.html"
																				class="menu-link">
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/utilities/modals/search/select-location.html"
																				class="menu-link">
																				<span class="menu-title">Select
																					Location</span>
																			</a>
																...
																<div class="col-lg-4 mb-6 mb-lg-0">
																	...
																	<div class="mb-0">
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/utilities/wizards/horizontal.html"
																				class="menu-link">
																				<span
																					class="menu-title">Horizontal</span>
																			</a>
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/utilities/wizards/vertical.html"
																				class="menu-link">
																				<span class="menu-title">Vertical</span>
																			</a>
																			<!--end:Menu link-->
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/utilities/wizards/two-factor-authentication.html"
																				class="menu-link">
																				<span class="menu-title">Two Factor
																					Auth</span>
																			</a>
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/utilities/wizards/create-app.html"
																				class="menu-link">
																				<span class="menu-title">Create
																					App</span>
																			</a>
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/utilities/wizards/create-campaign.html"
																				class="menu-link">
																				<span class="menu-title">Create
																					Campaign</span>
																			</a>
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/utilities/wizards/create-account.html"
																				class="menu-link">
																				<span class="menu-title">Create
																					Account</span>
																			</a>
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/utilities/wizards/create-project.html"
																				class="menu-link">
																				<span class="menu-title">Create
																					Project</span>
																			</a>
																		...
																		<div class="menu-item p-0 m-0">
																			<!--begin:Menu link-->
																			<a href="../../demo46/dist/utilities/wizards/offer-a-deal.html"
																				class="menu-link">
																				<span class="menu-title">Offer a
																					Deal</span>
																			</a>
												...
												<div class="tab-pane w-lg-500px" id="kt_app_header_menu_pages_widgets">
													...
													<div class="row">
														...
														<div class="col-lg-4 mb-6 mb-lg-0">
															...
															<div class="menu-item p-0 m-0">
																<!--begin:Menu link-->
																<a href="../../demo46/dist/widgets/lists.html"
																	class="menu-link">
															...
															<div class="menu-item p-0 m-0">
																<!--begin:Menu link-->
																<a href="../../demo46/dist/widgets/statistics.html"
																	class="menu-link">
															...
															<div class="menu-item p-0 m-0">
																<!--begin:Menu link-->
																<a href="../../demo46/dist/widgets/charts.html"
																	class="menu-link">
															...
															<div class="menu-item p-0 m-0">
																<!--begin:Menu link-->
																<a href="../../demo46/dist/widgets/mixed.html"
																	class="menu-link">
															...
															<div class="menu-item p-0 m-0">
																<!--begin:Menu link-->
																<a href="../../demo46/dist/widgets/tables.html"
																	class="menu-link">
															...
															<div class="menu-item p-0 m-0">
																<!--begin:Menu link-->
																<a href="../../demo46/dist/widgets/feeds.html"
																	class="menu-link">
																	<span class="menu-title">Feeds</span>
																</a>
																<!--end:Menu link-->
								...
								<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
									...
									<div
										...
										<div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
											...
											<div
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link"
														href="../../demo46/dist/apps/projects/list.html">
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link"
														href="../../demo46/dist/apps/projects/project.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link"
														href="../../demo46/dist/apps/projects/targets.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link"
														href="../../demo46/dist/apps/projects/budget.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link"
														href="../../demo46/dist/apps/projects/users.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title">Users</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link"
														href="../../demo46/dist/apps/projects/files.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link"
														href="../../demo46/dist/apps/projects/activity.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title">Activity</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link"
														href="../../demo46/dist/apps/projects/settings.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title">Settings</span>
										...
										<div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
											...
											<div
												...
												<div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
													...
													<div
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link"
																href="../../demo46/dist/apps/ecommerce/catalog/products.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link"
																href="../../demo46/dist/apps/ecommerce/catalog/categories.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link"
																href="../../demo46/dist/apps/ecommerce/catalog/add-product.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link"
																href="../../demo46/dist/apps/ecommerce/catalog/edit-product.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link"
																href="../../demo46/dist/apps/ecommerce/catalog/add-category.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link"
																href="../../demo46/dist/apps/ecommerce/catalog/edit-category.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
												...
												<div data-kt-menu-trigger="click"
													...
													<div class="menu-sub menu-sub-accordion">
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link"
																href="../../demo46/dist/apps/ecommerce/sales/listing.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link"
																href="../../demo46/dist/apps/ecommerce/sales/details.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link"
																href="../../demo46/dist/apps/ecommerce/sales/add-order.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link"
																href="../../demo46/dist/apps/ecommerce/sales/edit-order.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
												...
												<div data-kt-menu-trigger="click"
													...
													<div class="menu-sub menu-sub-accordion">
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link"
																href="../../demo46/dist/apps/ecommerce/customers/listing.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link"
																href="../../demo46/dist/apps/ecommerce/customers/details.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
												...
												<div data-kt-menu-trigger="click"
													...
													<div class="menu-sub menu-sub-accordion">
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link"
																href="../../demo46/dist/apps/ecommerce/reports/view.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link"
																href="../../demo46/dist/apps/ecommerce/reports/sales.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
																<span class="menu-title">Sales</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link"
																href="../../demo46/dist/apps/ecommerce/reports/returns.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link"
																href="../../demo46/dist/apps/ecommerce/reports/customer-orders.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link"
																href="../../demo46/dist/apps/ecommerce/reports/shipping.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link"
														href="../../demo46/dist/apps/ecommerce/settings.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title">Settings</span>
										...
										<div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
											...
											<div
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link"
														href="../../demo46/dist/apps/support-center/overview.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title">Overview</span>
												...
												<div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
													...
													<div
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link"
																href="../../demo46/dist/apps/support-center/tickets/list.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link"
																href="../../demo46/dist/apps/support-center/tickets/view.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
												...
												<div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
													...
													<div
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link"
																href="../../demo46/dist/apps/support-center/tutorials/list.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link"
																href="../../demo46/dist/apps/support-center/tutorials/post.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link"
														href="../../demo46/dist/apps/support-center/faq.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link"
														href="../../demo46/dist/apps/support-center/licenses.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title">Licenses</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link"
														href="../../demo46/dist/apps/support-center/contact.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
										...
										<div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
											...
											<div
												...
												<div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
													...
													<div
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link"
																href="../../demo46/dist/apps/user-management/users/list.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link"
																href="../../demo46/dist/apps/user-management/users/view.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
												...
												<div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
													...
													<div
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link"
																href="../../demo46/dist/apps/user-management/roles/list.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link"
																href="../../demo46/dist/apps/user-management/roles/view.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link"
														href="../../demo46/dist/apps/user-management/permissions.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
										...
										<div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
											...
											<div
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link"
														href="../../demo46/dist/apps/contacts/getting-started.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link"
														href="../../demo46/dist/apps/contacts/add-contact.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link"
														href="../../demo46/dist/apps/contacts/edit-contact.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link"
														href="../../demo46/dist/apps/contacts/view-contact.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
										...
										<div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
											...
											<div
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link"
														href="../../demo46/dist/apps/subscriptions/getting-started.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title">Getting Started</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link"
														href="../../demo46/dist/apps/subscriptions/list.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link"
														href="../../demo46/dist/apps/subscriptions/add.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link"
														href="../../demo46/dist/apps/subscriptions/view.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
										...
										<div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
											...
											<div
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link"
														href="../../demo46/dist/apps/customers/getting-started.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title">Getting Started</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link"
														href="../../demo46/dist/apps/customers/list.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link"
														href="../../demo46/dist/apps/customers/view.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
										...
										<div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
											...
											<div
												...
												<div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
													...
													<div
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link"
																href="../../demo46/dist/apps/invoices/view/invoice-1.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link"
																href="../../demo46/dist/apps/invoices/view/invoice-2.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link"
																href="../../demo46/dist/apps/invoices/view/invoice-3.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link"
														href="../../demo46/dist/apps/invoices/create.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
										...
										<div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
											...
											<div
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link"
														href="../../demo46/dist/apps/file-manager/folders.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link"
														href="../../demo46/dist/apps/file-manager/files.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title">Files</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link"
														href="../../demo46/dist/apps/file-manager/blank.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link"
														href="../../demo46/dist/apps/file-manager/settings.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title">Settings</span>
										...
										<div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
											...
											<div
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link"
														href="../../demo46/dist/apps/inbox/listing.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link"
														href="../../demo46/dist/apps/inbox/compose.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link" href="../../demo46/dist/apps/inbox/reply.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
										...
										<div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
											...
											<div
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link"
														href="../../demo46/dist/apps/chat/private.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link" href="../../demo46/dist/apps/chat/group.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link" href="../../demo46/dist/apps/chat/drawer.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
										...
										<div class="menu-item">
											<!--begin:Menu link-->
											<a class="menu-link" href="../../demo46/dist/apps/calendar.html">
												<span class="menu-icon">
								...
								<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
									...
									<div
										...
										<div class="menu-item">
											<!--begin:Menu link-->
											<a class="menu-link"
												href="https://preview.keenthemes.com/metronic8/demo46/layout-builder.html"
						...
						<div class="app-navbar flex-shrink-0">
							...
							<div class="d-flex align-items-center ms-1 ms-lg-3">
								<a href="#" class="btn btn-flex flex-center btn-primary h-35px h-md-40px"
							...
							<div class="app-navbar-item ms-1 ms-lg-3">
								...
								<div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px"
									...
									<div class="row g-0">
										<!--begin:Item-->
										<div class="col-6">
											<a href="../../demo46/dist/apps/projects/budget.html"
										...
										<!--begin:Item-->
										<div class="col-6">
											<a href="../../demo46/dist/apps/projects/settings.html"
										...
										<!--begin:Item-->
										<div class="col-6">
											<a href="../../demo46/dist/apps/projects/list.html"
										...
										<!--begin:Item-->
										<div class="col-6">
											<a href="../../demo46/dist/apps/projects/users.html"
							...
							<div class="app-navbar-item ms-5" id="kt_header_user_menu_toggle">
								...
								<div class="cursor-pointer symbol symbol-35px symbol-md-40px"
									data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent"
									data-kt-menu-placement="bottom-end">
									<img class="symbol symbol-35px symbol-md-40px" src="assets/media/avatars/300-3.jpg"
										alt="user" />
								</div>
								...
								<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
									...
									<div class="menu-item px-5">
										<a href="../../demo46/dist/account/overview.html" class="menu-link px-5">My
											Profile</a>
									</div>
									<!--end::Menu item-->
									<!--begin::Menu item-->
									...
									<!--begin::Menu item-->
									<div class="menu-item px-5">
										<a href="../../demo46/dist/account/statements.html" class="menu-link px-5">My
											Statements</a>
									</div>
									<!--end::Menu item-->
									<!--begin::Menu separator-->
									...
									<div class="menu-item px-5 my-1">
										<a href="../../demo46/dist/account/settings.html" class="menu-link px-5">Account
											Settings</a>
									</div>
									<!--end::Menu item-->
									<!--begin::Menu item-->
